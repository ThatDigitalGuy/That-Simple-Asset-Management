<script lang="ts">
  ...
  let navActive = "bg-accent text-accent-foreground hover:text-foreground flex h-9 w-9 items-center justify-center rounded-lg transition-colors md:h-8 md:w-8"
  let navNormal = "text-muted-foreground hover:text-foreground flex h-9 w-9 items-center justify-center rounded-lg transition-colors md:h-8 md:w-8"
</script>
    ...
    <nav class="flex flex-col items-center gap-4 px-2 sm:py-5">
      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild let:builder>
          <a
            href="/dashboard"
            class={currentPath == "/dashboard" ? navActive : navNormal}
            use:builder.action
            {...builder}
          >
            <Home class="h-5 w-5" />
      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild let:builder>
          <a
            ...
            class={currentPath == "/dashboard/users" ? navActive : navNormal}
            use:builder.action
            {...builder}
          >
    ...
    >
      ...
      <DropdownMenu.Root>
        <DropdownMenu.Trigger asChild let:builder>
          ...
          >
            <img
              src="https://cdn.statically.io/avatar/shape=circle/bar"
              width={36}
              height={36}
              alt="Avatar"
              class="overflow-hidden rounded-full"
